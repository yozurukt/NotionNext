    ...
    <div className='flex flex-col justify-between md:mt-20 md:h-[70vh]'>
      ...
      <nav className='md:pt-0  z-20   flex-shrink-0'>
        ...
        <div className='flex items-center justify-center md:justify-start mt-4'>
          <div onClick={() => searchModal?.current?.openSearch()} className='cursor-pointer text-md text-gray-600 dark:text-gray-400 hover:text-[var(--primary-color)] dark:hover:text-white transition-colors duration-150' title='Search'>
            检索
          </div>
        </div>
        <SocialButton />
